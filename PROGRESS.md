...
- **⏸️ 종료 시 EC2·RDS 정지 완료**. ✅ EIP 덕에 **재시작해도 오리진 갱신 불필요**(07-12 경고 해소). EC2=`i-06da19f44d1f38eff`, RDS=`blog-db`.

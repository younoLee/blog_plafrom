...
두 가지 용도:
  ...
  2) ~~데모: 포트폴리오 방문자용 '체험 계정'~~ — **2026-08-07에 폐지됐다.**
     프론트의 '체험 계정으로 둘러보기' 버튼은 `8d3fd62`로 지워졌고(RegisterPage.tsx:52),
     운영 데모 계정도 삭제됐다. `--demo`는 지금 **공개된 비밀번호의 writer 계정을
     되살리는 스위치**라 쓰지 말 것 — 2026-08-11 공백검사에서 이 서술이 그걸
     되살릴 유일하게 남은 유인이었다.

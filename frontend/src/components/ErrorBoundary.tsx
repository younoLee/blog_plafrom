    ...
    return (
      <div className="mx-auto mt-16 max-w-lg rounded-2xl border border-red-200 bg-white p-6 text-sm dark:border-red-500/30 dark:bg-white/[0.06]">
        ...
        <button
          ...
          className="mt-4 inline-flex items-center justify-center rounded-full bg-accent px-4 py-2 text-sm font-medium text-on-accent transition hover:bg-accent-hi"
        >
          새로고침
        </button>
      </div>
